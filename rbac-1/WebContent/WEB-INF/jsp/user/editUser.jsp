						...
						<form role="form" id="addForm">
							...
							<div class="form-group">
								...
								<input
									...
									id="exampleInputPassword1" value="${user.userName }">
							</div>
							<div class="form-group">
								<label for="exampleInputPassword1">真实姓名</label> <input
									id="userTrueName" name="userTrueName" type="text"
							...
							<div class="form-group">
								<label for="exampleInputPassword1">用户状态</label> 
								<select id="userState" name="userState">
									<option value="0">冻结账户</option>
									<option value="1">解冻账户</option>
								</select>
							</div>
