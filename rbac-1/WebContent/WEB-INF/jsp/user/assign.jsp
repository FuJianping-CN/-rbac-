					...
					<form class="form-inline" role="form" style="float: left;">
						<div class="form-group has-feedback">
							<div class="input-group">
								<div class="input-group-addon">被授权用户id</div>
						...
						<div class="form-group has-feedback">
							<div class="input-group">
								...
								<input class="form-control has-success" type="text"
									value="${user.userName}" readonly="readonly" style="color:red;">
							</div>
						</div>
						<div class="form-group has-feedback">
							<div class="input-group">
								<div class="input-group-addon">用户真实姓名</div>
								<input class="form-control has-success" type="text"
									value="${user.userTrueName}" readonly="readonly" style="color:red;">
							</div>
						</div>
					</form>
				</div>
						...
						<form id="roleForm" role="form" class="form-inline">
							...
							<div class="form-group">
								<label for="exampleInputPassword1">未分配角色列表</label><br> <select
									id="leftList" name="unassignroleids" class="form-control"
							...
							<div class="form-group" style="margin-left: 40px;">
								<label for="exampleInputPassword1">已分配角色列表</label><br> <select
									id="rightList" name="assingroleids" class="form-control"
									multiple size="10" style="width: 100px; overflow-y: auto;">
