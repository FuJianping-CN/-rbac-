...
<body>
					...
					<div class="panel-body">
						<form role="form" id="addForm">
							<div class="form-group">
								<label for="exampleInputPassword1">试题类型名称</label> 
								<input
									id="quesTypeName" name="quesTypeName" type="text" class="form-control"
									 value="${quesType.quesTypeName }">
							</div>
							<div class="form-group">
								<label for="exampleInputPassword1">试题类型描述</label> 
								<input
									id="quesTypeContent" name="quesTypeContent" type="text"
									class="form-control" 
									 value="${quesType.quesTypeContent }">
							</div>
							<div class="form-group">
								<label for="exampleInputPassword1">考试时长</label> 
								<input
									id="examTime" name="examTime" type="text"
									class="form-control" 
									 value="${quesType.examTime }">
							</div>
							<button type="button" class="btn btn-success" onclick="editQuesType(${quesType.quesTypeId });">
	...
	<script type="text/javascript">
		function editQuesType(quesTypeId) {
...
// 					+ ", authParentRoot = " + authParentRoot + ", authIsRoot = " + authIsRoot)
			$.ajax({
				type : "POST",
				url : "${PATH}/quesType/updateQuesTypeIdById",
				data : {
