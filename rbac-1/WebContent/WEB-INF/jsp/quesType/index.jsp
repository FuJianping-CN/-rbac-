				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<form class="form-inline" role="form" style="float: left;">
							...
							<div class="form-group has-feedback">
								<div class="input-group">
									<div class="input-group-addon">该类型考试时长</div>
									<input class="form-control has-success" type="text"
										placeholder="单位为分钟，输入整型" name="examTime" id="examTime">
								</div>
							</div>
						...
						<div class="table-responsive">
							<table class="table  table-bordered">
								...
								<tbody>
									<c:forEach items="${pageInfo.list}" var="quesType" varStatus="s">
										<tr>
											<td>${s.count }</td>
											...
											<td><fmt:formatDate 
												value="${quesType.createDate}" 
												pattern="yyyy年MM月dd日" />
											</td>
<%-- 											<td>${role.createDate}</td> --%>
											<td>${quesType.updater}</td>
											<td><fmt:formatDate 
												value="${quesType.updateDate}" 
												pattern="yyyy年MM月dd日" />
											</td>
											<td>
												<button title="试题管理" type="button" id="assignRole"
													onclick="quesManage(${quesType.quesTypeId});"
												...
												<button title="删除试题类型" type="button"
													...
													onclick="deleteQuesType(${quesType.quesTypeId});">
