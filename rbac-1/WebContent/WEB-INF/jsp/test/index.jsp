...
<!-- 						</form> -->
						...
						<div class="table-responsive">
							<table class="table  table-bordered">
								...
								<tbody>
									<c:forEach items="${pageInfo.list}" var="test" varStatus="s">
										<tr>
											<!-- 											<td><input type="checkbox"></td> -->
											<td>${test.testId }</td>
											<td>${test.quesTypeName }</td>
											<td>${test.grade }</td>
											<td><fmt:formatDate 
												value="${test.createDate}" 
												pattern="yyyy年MM月dd日" />
											</td>
...
<!-- 											</td> -->
											<td>
												<button title="查看试卷详情" type="button" id="assignRole"
													onclick="toTestDetail(${test.testId});"
													class="btn btn-success btn-xs">
													<i class=" glyphicon glyphicon-check"></i>&nbsp;试卷详情
												</button>
...
<!-- 												</button> -->
												<button title="删除考试记录" type="button"
													class="btn btn-danger btn-xs"
													onclick="deleteTestRecord(${test.testId});">
	...
	<script>
            ...
            */
            function deleteTestRecord(testId) {
            	alert("确定删除编号为" + testId + "的考试记录吗？")
	            	$.ajax({
	               	 type: "POST",
	               	 url: "${PATH}/test/deleteTestById",
	               	 data: {
	               		 "testId":testId
	               	 },
...
//             	window.location.href='/WEB-INF/jsp/user/addUser.jsp' 
            ...
            function toTestDetail(testId) {
//             	window.location.href='/WEB-INF/jsp/user/addUser.jsp' toTestDetail
            	location.href="${PATH}/test/toTestDetail?testId="+testId;
            }
        </script>
</body>
</html>