...
<!-- 										placeholder="请输入权限名称" name="authName" id="authName"> -->
<!-- 								</div> -->
<!-- 							</div> -->
<!-- 							<div class="form-group has-feedback"> -->
<!-- 								<div class="input-group"> -->
...
<!-- 									<input class="form-control has-success" type="text" -->
<!-- 										placeholder="请输入访问路径" name="authUrl" id="authUrl"> -->
<!-- 								</div> -->
<!-- 							</div> -->
<!-- 							<br /> -->
<!-- 							<div class="form-group has-feedback"> -->
<!-- 								<div class="input-group"> -->
<!-- 									<div class="input-group-addon">所属节点</div> -->
...
<!-- 							<div class="form-group has-feedback"> -->
<!-- 								<div class="input-group"> -->
<!-- 									<div class="input-group-addon">是否是根结点</div> -->
								...
								<tbody>
									<c:forEach items="${pageInfo.list}" var="permission"
										...
										<tr>
											...
											<td>${permission.authName }</td>
											<td>${permission.authParentRoot }</td>
											<td>${permission.authUrl}</td>
											<td>${permission.creator}</td>
											<td><fmt:formatDate value="${permission.createDate}"
													pattern="yyyy年MM月dd日" /></td>
											<%-- 											<td>${role.createDate}</td> --%>
											<td>${permission.updater}</td>
											<td><fmt:formatDate value="${permission.updateDate}"
													pattern="yyyy年MM月dd日" /></td>
											<td>
												<button title="修改权限" type="button"
													onclick="toEditAuth(${permission.authId});"
													class="btn btn-primary btn-xs">
													<i class=" glyphicon glyphicon-pencil"></i>
												</button>
												<button title="删除权限" type="button"
													class="btn btn-danger btn-xs"
													onclick="deleteAuth(${permission.authId});">
	...
	<script>
            ...
            */
            function deleteAuth(authId) {
            	alert("确定删除编号为" + authId + "的权限吗？")
	            	$.ajax({
	               	 type: "POST",
	               	 url: "${PATH}/permission/deleteAuthById",
	               	 data: {
	               		 "authId":authId
	               	 },
...
//                		 layer.msg("用户删除失败",{timer:1000,icon:5,shift:6},function(){});
            ...
            function toEditAuth(authId){
            	location.href="${PATH}/permission/toEditAuth?authId="+authId;
            }
            function toAddAuth() {
//             	window.location.href='/WEB-INF/jsp/user/addUser.jsp'
            	location.href="${PATH}/permission/toAddAuth";
            }
        </script>
</body>
</html>