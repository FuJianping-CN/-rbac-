...
<!-- 						</form> -->
						...
						<div class="table-responsive">
							<table class="table  table-bordered">
								...
								<tbody>
									<c:forEach items="${pageInfo.list}" var="quesCollect" varStatus="s">
										<tr>
											<!-- 											<td><input type="checkbox"></td> -->
											<td>${quesCollect.collectId }</td>
											<td>${quesCollect.quesTypeName }</td>
											<td>${quesCollect.quesId }</td>
											<td width="400px;">${quesCollect.quesContent }</td>
...
<!-- 											</td> -->
											<td>
												<button title="查看试题详情" type="button" id="assignRole"
													onclick="questionDetail(${quesCollect.quesId});"
...
<!-- 												</button> -->
												<button title="删除试题类型" type="button"
													...
													onclick="deleteQuesCollect(${quesCollect.collectId});">
													<i class=" glyphicon glyphicon-remove"></i>&nbsp;取消收藏
												</button>
	...
	<script>
            ...
            */
            function deleteQuesCollect(collectId) {
            	alert("确定删除收藏的试题编号为" + collectId + "的试题吗？")
	            	$.ajax({
	               	 type: "POST",
	               	 url: "${PATH}/quesCollect/deleteQuesCollectById",
	               	 data: {
	               		 "collectId":collectId
	               	 },
