...
<!-- 						</form> -->
						...
						<div>
							...
							<label>试题所属类别：<span style="color: blue;">${quesType.quesTypeName}</span></label> 
							<br><br>

								<p><label>&nbsp;&nbsp;${question.quesContent}</label></p>
								...
								<hr>
								<label>正确答案：<span style="color: red;">${question.quesAnswer}</span></label> 
						</div>
					</div>
